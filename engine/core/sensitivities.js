...
//   Levers: ICE, FOB premium, TC rate, FX (NAFEM), surcharge on/off.
...
function runSensitivities(trade, computeFn, pct = 0.1) {
  ...
  const hasNgnLegs = base.cost.lines.some((l) => l.currency === 'NGN');
